...
public class BuiltInRuleInteractionFactory {
    private static Map<Class<? extends IBuiltInRuleApp>, Factory<? extends IBuiltInRuleApp>> map =
        new HashMap<>();
    ...
    static {
        ...
        register(LoopContractInternalBuiltInRuleApp.class,
            LoopContractInternalBuiltInRuleInteraction::new);
    ...
    public static <T extends IBuiltInRuleApp> void register(Class<T> clazz, Factory<T> factory) {
    ...
    public static <T extends IBuiltInRuleApp> BuiltInRuleInteraction create(Node node, T app) {
        ...
        if (factory == null) {
            throw new IllegalStateException(
                "No handler registered for built in rule: " + app.rule());
        }
