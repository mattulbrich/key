...
public class TestJMLPreTranslator {
    ...
    public void testComplexSpec() {
        ImmutableList<TextualJMLConstruct> constructs = parseMethodSpec("/*@ behaviour\n"
            + "  @  requires true;\n"
    ...
    public void testMultipleSpecs() {
        ImmutableList<TextualJMLConstruct> constructs = parseMethodSpec("//@ normal_behaviour\n"
            + "//@  ensures false\n"
            + "//@          || true;\n"
            + "//@  assignable \\nothing;\n"
            + "//@ also exceptional_behaviour\n"
    ...
    public void testFailure2() {
        assertThrows(Exception.class, () -> parseMethodSpec("/*@ behaviour\n"
            + "  @  requires (;((;;);();();(();;;(;)));\n"
            + "  @*/"));
    }
}
