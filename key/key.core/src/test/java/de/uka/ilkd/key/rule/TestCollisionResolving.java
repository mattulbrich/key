...
public class TestCollisionResolving {
    ...
    public void testCollisionResolvingOfSchemaVariable() {
        ...
        TacletApp result = NoPosTacletApp.createNoPosTacletApp(coll_varSV,
            coll_varSV.getMatcher().matchFind(term,
    ...
    public void testCollisionResolvingWithContext() {
        ...
        TacletApp result = PosTacletApp.createPosTacletApp(coll_varSV,
            coll_varSV.getMatcher().matchFind(term.sub(0),
                MatchConditions.EMPTY_MATCHCONDITIONS,
                services),
            pos, services);
    ...
    public void testVarNamespaceCreationWithContext() {
        ...
        TacletApp app = PosTacletApp.createPosTacletApp(taclet,
            taclet.getMatcher().matchFind(term.sub(0),
                MatchConditions.EMPTY_MATCHCONDITIONS,
                null),
            pos,
            services);
