...
public class TestMatchTaclet {
    ...
    public void testVarOccursInIfAndAddRule() {
        ...
        assertEquals(0, NoPosTacletApp.createNoPosTacletApp(if_addrule_conflict)
        ...
        assertNotEquals(0, NoPosTacletApp.createNoPosTacletApp(if_addrule_conflict)
                .findIfFormulaInstantiations(seq, services).size(),
    ...
    public void testVarOccursInFindAndAddRule() {
        ...
        assertNull(app, "A match has been found but there is a free variable in" +
    ...
    public void testRWVarOccursFindAndIf() {
        ...
        // matching to a should be not possible
        Term match = TacletForTests.parseTerm("\\forall testSort z; (p(z) -> A)");
        TacletApp app = PosTacletApp.createPosTacletApp(if_find_clash,
    ...
    public void testRWVarOccursInAddAndIf() {
        ...
        assertNotNull(if_add_no_clash.getMatcher().matchFind(match.sub(0),
            MatchConditions.EMPTY_MATCHCONDITIONS, services),
            "Match not found but should exist" +
    ...
    public void testXNotFreeInYConflict() {
        ...
        assertNull(NoPosTacletApp.createNoPosTacletApp(not_free_conflict,
            not_free_conflict.getMatcher().matchFind(free_in,
                MatchConditions.EMPTY_MATCHCONDITIONS, services),
            services),
            "Match should not be found because of conflict with " +
                "..not free in..");

        Term not_free_in = TacletForTests.parseTerm("\\forall testSort z; (p(z) & p(c))");
        assertNotNull(NoPosTacletApp.createNoPosTacletApp(not_free_conflict,
            not_free_conflict.getMatcher().matchFind(not_free_in,
                MatchConditions.EMPTY_MATCHCONDITIONS, services),
            services),
            "Match should be found because .. not free in.. " +
                "is not relevant");
    }
    ...
    public void testPrefixMatching() {
        ...
        ExecutionContext ec = new ExecutionContext(
            new TypeRef(new KeYJavaType(PrimitiveType.JAVA_BYTE,
        ...
        match = TB.dia(JavaBlock.createJavaBlock(new StatementBlock(mframe)),
            match.sub(0));
        FindTaclet taclet =
    ...
    public void testBugsThathaveBeenRemoved() {
        ...
        assertNull(mc, "The reason for this bug was related to the introduction of " +
