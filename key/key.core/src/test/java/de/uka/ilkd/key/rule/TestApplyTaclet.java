...
public class TestApplyTaclet {
    ...
    public void testAddingRule() {
        ...
        PosInOccurrence applyPos = new PosInOccurrence(goal.sequent().succedent().getFirst(),
            ...
            false);
        ImmutableList<TacletApp> rApplist =
            goal.ruleAppIndex().getTacletAppAt(TacletFilter.TRUE, applyPos,
                null);
        assertEquals(1, rApplist.size(), "Too many or zero rule applications.");
        RuleApp rApp = rApplist.head();
        assertTrue(rApp.complete(), "Rule App should be complete");
        ...
        ImmutableList<NoPosTacletApp> nfapp = goals.head().indexOfTaclets().getNoFindTaclet(
            new IHTacletFilter(true, ImmutableSLList.nil()),
            null);
        ...
        assertTrue(seq1.succedent().getFirst().formula().equals(aimpb) ||
    ...
    public void testTacletWithIf() {
        ...
        PosInOccurrence applyPos = new PosInOccurrence(goal.sequent().succedent().getFirst(),
            PosInTerm.getTopLevel(),
            false);
        ImmutableList<TacletApp> rApplist = goal.ruleAppIndex().getTacletAppAt(TacletFilter.TRUE,
            applyPos, null);
    ...
    public void testNoFindTacletWithoutIf() {
        ...
        if (!seq1.antecedent().isEmpty()
            ...
            assertTrue(seq2.succedent().getFirst().formula().equals(t_c)
                    || seq2.succedent().get(1).formula().equals(t_c),
                "D is in antecedent of 1st goal but not in succedent of 2nd");
        } else {
            assertTrue(seq1.succedent().getFirst().formula().equals(t_c)
                    || seq1.succedent().get(1).formula().equals(t_c),
                "D is not in antecedent and not in succedent "
                    + "of first new goal");
    ...
    public void testIncompleteSuccTacletApp() {
        ...
        orright = orright.setPosInOccurrence(new PosInOccurrence(seq.succedent().get(0),
            PosInTerm.getTopLevel(),
            false),
            services);
        assertTrue(orright.complete(), "TacletApp should now be complete with Position set and SVs "
            + "instantiated");
    }
    ...
    public void testPrgTacletApp() {
        ...
        SchemaVariable e2 =
            TacletForTests.getSchemaVariables().lookup(new Name("#e2"));
        SchemaVariable p1 =
            TacletForTests.getSchemaVariables().lookup(new Name("#p1"));
    ...
    public void testBugBrokenApply() {
        ...
        assertTrue(goals.head().sequent().antecedent().size() == 1 &&
                ...
                goals.head().sequent().succedent().iterator().next().formula()
                        .op() == Quantifier.ALL,
            "First goal should be 'b==>b', but is " +
                goals.head().sequent());
        goals = goals.tail();
        assertTrue(goals.head().sequent().antecedent().size() == 0 &&
                goals.head().sequent().succedent().size() == 1 &&
                goals.head().sequent().succedent().iterator().next().formula()
                        .op() == Quantifier.ALL,
            "Second goal should be '==>b', but is " +
                goals.head().sequent());
    ...
    public void testBugID176() {
        ...
        assertTrue(goals.head().sequent().isEmpty(), "Expected '==>', but is " +
            goals.head().sequent());
    ...
    public void testBugID177() {
        ...
        assertTrue(goals.head().sequent().antecedent().size() == 2 &&
    ...
    public void testBugID188() {
        ...
        rApplist = goal.ruleAppIndex().getTacletAppAt(TacletFilter.TRUE,
            pio, null);
    ...
    public void testModalityLevel1() {
        ...
        PosInOccurrence pos = new PosInOccurrence(goal.sequent().succedent().getFirst(),
            ...
            false);
        ImmutableList<TacletApp> rApplist =
            goal.ruleAppIndex().getTacletAppAtAndBelow(TacletFilter.TRUE, pos,
                services);
        ...
        while (appIt.hasNext())
            appList = appList.prepend(appIt.next().findIfFormulaInstantiations(goal.sequent(),
                services));
        ...
        ImmutableList<IfFormulaInstantiation> ifInsts =
            ImmutableSLList.<IfFormulaInstantiation>nil()
                    .prepend(new IfFormulaInstDirect(ifformula));
    ...
    public void testModalityLevel2() {
        ...
        pos = new PosInOccurrence(goal.sequent().succedent().getFirst(),
            PosInTerm.getTopLevel(),
            false);
        rApplist = goal.ruleAppIndex().getTacletAppAtAndBelow(TacletFilter.TRUE, pos,
            services);
    ...
    private void doTestCatchList(int p_proof) {
        ...
        assertTrue(resultFormula.equalsModRenaming(correctFormula),
            "Wrong result. Expected:"
                + ProofSaver.printAnything(correctFormula, TacletForTests.services()) +
                " But was:" +
    ...
    public void testTacletVariableCollector() {
        ...
        assertEquals(4, collSet.size(), "Expected four uninstantiated variables in taclet " +
            t + ", but found " + collSet.size());
    }
    ...
    public void testAddExistingFormulaTwoInSucc2() {
        ...
        pos = new PosInOccurrence(goal.sequent().succedent().get(1),
            PosInTerm.getTopLevel(),
            false);
    ...
    public void testAddExistingFormulaTwoInAntec() {
        ...
        pos = new PosInOccurrence(goal.sequent().antecedent().get(0),
            PosInTerm.getTopLevel(),
            true);
    ...
    public void testAddExistingFormulaTwoInAntec2() {
        ...
        pos = new PosInOccurrence(goal.sequent().antecedent().get(1),
            PosInTerm.getTopLevel(),
            true);
