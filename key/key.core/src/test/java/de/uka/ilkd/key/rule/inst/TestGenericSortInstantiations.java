...
public class TestGenericSortInstantiations {

    static final ImmutableSet<Sort> emptySortSet = DefaultImmutableSet.nil();
    ...
    public void testGeneric1() {
        ...
        assertEquals(DefaultImmutableMap.<GenericSort, Sort>nilMap()
                .put(G1, A4),
