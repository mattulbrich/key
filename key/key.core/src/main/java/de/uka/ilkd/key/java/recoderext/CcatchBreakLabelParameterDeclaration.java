...
public class CcatchBreakLabelParameterDeclaration
    ...
    public CcatchBreakLabelParameterDeclaration() {

    }

    public CcatchBreakLabelParameterDeclaration(Identifier label) {
        this.label = label;
    }
    ...
    @Override
    public CcatchBreakLabelParameterDeclaration deepClone() {
        return new CcatchBreakLabelParameterDeclaration();
    }
