...
public class ExpandQueriesMetaConstruct extends AbstractTermTransformer {
     ...
     * meta construct appears in a positive context wrt. to logical negation, (e.g. in the succedent
     * or negated in the antecedent)
     * False implies means that the meta construct appears in a negative context. (e.g. in the
     * antecedent or negated in the succedent)
     */
