...
public class JavaCardDLStrategyFactory implements StrategyFactory {
    ...
    public static final String TOOL_TIP_LOOP_SCOPE_INVARIANT = "<html>"
        ...
        + "</html>";
    public static final String TOOL_TIP_LOOP_SCOPE_INVARIANT_TACLET = "<html>"
        ...
        + "</html>";
    public static final String TOOL_TIP_LOOP_SCOPE_EXPAND = "<html>"
    ...
    public static final String TOOL_TIP_BLOCK_CONTRACT_INTERNAL = "<html>"
        ...
        + "</ul>"
        + "</html>";
    public static final String TOOL_TIP_BLOCK_CONTRACT_EXTERNAL = "<html>"
        + "Java blocks are replaced by their contracts.<br>"
