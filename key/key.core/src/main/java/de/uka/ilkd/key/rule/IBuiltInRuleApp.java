...
public interface IBuiltInRuleApp extends RuleApp {
     ...
     * Instead ask the implementation of the {@link de.uka.ilkd.key.control.UserInterfaceControl} to
     * complete a built-in rule.
     ...
     * For an example implementation see e.g. {@link UseOperationContractRule} or
     * {@link UseDependencyContractRule}.
     */
