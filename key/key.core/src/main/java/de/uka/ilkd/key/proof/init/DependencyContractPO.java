...
public final class DependencyContractPO extends AbstractPO
    ...
    private Term buildFreePre(
        ...
        // "self != null"
        final Term selfNotNull = selfVar == null
                ? tb.tt()
    ...
    public void readProblem() throws ProofInputException {
        ...
        // prepare variables
        final ProgramVariable selfVar = !contract.getTarget().isStatic()
                ? tb.selfVar(contract.getKJT(), true)
                : null;
        ...
        for (LocationVariable h : HeapContext.getModHeaps(proofServices, false)) {
            ...
            heaps.add(h);
            LocationVariable preVar = twoState ? tb.heapAtPreVar(h.name() + "AtPre", h.sort(), true)
                    : null;
            if (preVar != null) {
