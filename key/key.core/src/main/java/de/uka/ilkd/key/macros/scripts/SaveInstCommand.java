 ...
 * application. Saves the instantiation of a {@link SchemaVariable} by the last
 * {@link TacletApp} into an abbreviation for later use. A nice use case is a
        ...
        for (Map.Entry<String, String> entry : args.entrySet()) {
            ...
            try {
                ...
                if (ruleApp instanceof TacletApp) {
                    ...
                    final Object inst = tacletApp.matchConditions()
                            .getInstantiations().lookupValue(new Name(value));
                    if (inst != null
                            && ((Term) inst).op() instanceof Function) {
