...
/**
 * The class <code>ContextualBlock</code> is used to integrate comments to translations of
 * AbstractSMTtranslator. A concrete instance of <code>ContexualBlock</code>
 * describes either a block of semantical connected assumptions or a block of semantical connected
 * predicates.
 * How the assumptions or predicates are connected are described by the constants declared within
 * this class.
 ...
 *	    ArrayList<StringBuffer> types, SortHierarchy sortHierarchy)</code><br>
 * <br>
 * can use <code>assumptionBlocks</code> and <code>predicateBlocks</code> to find out, at which
 * position in the containers <code>assumptions</code>
