...
public class DirectoryFileCollection implements FileCollection {
     ...
     * \bootclasspath "
     * The method sorts the List of File that is given as parameter according to the following
     * criteria:
     * - File paths that contain the subpath "java/lang" are stored before other file paths.
     * - If there is a File that contains the subpath "java/lang/Object.java" then it is stored at
