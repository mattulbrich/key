...
public final class LegacyTacletMatcher implements TacletMatcher {
            ...
            for (TermLabel l : labels) {
                ...
                if (l instanceof SchemaVariable) {
                    ...
                    final MatchConditions cond =
                        ElementMatcher.getElementMatcherFor(schemaLabel).match(schemaLabel, term,
                            matchCond, services);
                    if (cond == null) {
                        return null;
                    }
    ...
    public final IfMatchResult matchIf(ImmutableList<IfFormulaInstantiation> p_toMatch,
        ...
        if (p_matchCond.getInstantiations().getUpdateContext().isEmpty())
            ...
            updateFormula = p_services.getTermBuilder()
                    .applyUpdatePairsSequential(p_matchCond.getInstantiations()
                            .getUpdateContext(),
                        p_template);
