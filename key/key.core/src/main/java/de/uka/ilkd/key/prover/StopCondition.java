 ...
 * {@link #isGoalAllowed(ApplyStrategy, int, long, Proof, GoalChooser, long, int, Goal)}.
 * If this method returns {@code false} the strategy stops and the reason
 * shown to the user is computed via
 ...
 * </p>
 * <p>
 * <b>Attention: </b> It is possible that an {@link StopCondition} has to check
...
public interface StopCondition {
     ...
     * chosen by the {@link GoalChooser} before it is applied.
