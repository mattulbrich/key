...
public class SVInstantiations {
    ...
    private SVInstantiations rebuildSorts(Services services) {
        genericSortInstantiations = GenericSortInstantiations.create(map.iterator(),
    ...
    public boolean isEmpty() {
        ...
        return this == EMPTY_SVINSTANTIATIONS ||
                (map.isEmpty() && updateContext.isEmpty() && genericSortConditions.isEmpty()
                        && genericSortInstantiations.isEmpty());
    }
