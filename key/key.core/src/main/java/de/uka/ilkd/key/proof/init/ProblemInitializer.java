...
public final class ProblemInitializer {
    ...
    private void readJava(EnvInput envInput, InitConfig initConfig)
        ...
        if (javaPath != null) {
            ...
            final ProjectSettings settings = initConfig.getServices()
                    .getJavaInfo()
                    .getKeYProgModelInfo()
                    .getServConf()
                    .getProjectSettings();
    ...
    public void readEnvInput(EnvInput envInput,
            InitConfig initConfig)
            throws ProofInputException {
    ...
    private void populateNamespaces(Term term,
        ...
        if (term.op() instanceof Function) {
            ...
            final ImmutableSet<ProgramVariable> freeProgVars = MiscTools.getLocalIns(pe, serv)
