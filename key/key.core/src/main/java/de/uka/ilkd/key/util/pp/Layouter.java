 ...
 *
 * <P>
 * The formatted output is directed to a <em>backend</em> which
 ...
 * by opening a block which sets the indentation level to the column where the <code>G</code> ends
 * up and outdenting the lines with the <code>and</code>:
 *
 * <pre>
 ...
 *
 * <P>
 * Most of the methods can throw an {@link UnbalancedBlocksException},
 ...
 *
 * <P>
 * Also, most methods can throw an {@link java.io.IOException}.
