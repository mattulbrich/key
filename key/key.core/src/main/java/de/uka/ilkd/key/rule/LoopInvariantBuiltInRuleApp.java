...
public class LoopInvariantBuiltInRuleApp extends AbstractBuiltInRuleApp {
    ...
    protected LoopInvariantBuiltInRuleApp(BuiltInRule rule,
            ...
            LoopSpecification inv, List<LocationVariable> heapContext, TermServices services) {
     ...
     * The index function symbol is a placeholder which stems from translating the
     * <code>\index</code> keyword from JML.
     * The values function symbol is a placeholder which stems from translating the
    ...
    protected LoopInvariantBuiltInRuleApp(BuiltInRule rule,
            PosInOccurrence pio, LoopSpecification inv, TermServices services) {
