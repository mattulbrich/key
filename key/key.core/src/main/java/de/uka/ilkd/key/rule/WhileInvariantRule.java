...
public final class WhileInvariantRule implements BuiltInRule {
    ...
    private static InfFlowData prepareSetUpOfInfFlowValidityGoal(final Goal infFlowGoal,
        ...
        final Taclet informationFlowInvariantApp =
            ifInvariantBuilder.buildTaclet(infFlowGoal);
    ...
    private Term bodyTerm(TermLabelState termLabelState, Services services, RuleApp ruleApp,
        ...
        fullInvariant = TermLabelManager.refactorTerm(termLabelState, services, null,
            fullInvariant, this, bodyGoal,
    ...
    private Term useCaseFormula(TermLabelState termLabelState, Services services, RuleApp ruleApp,
        ...
        final ImmutableArray<TermLabel> instantiateLabels =
            TermLabelManager.instantiateLabels(termLabelState, services,
                ...
                useGoal, "UseModality", null, inst.progPost.op(),
    ...
    private void prepareUseCaseBranch(TermLabelState termLabelState,
        ...
        Term guardFalseRestPsi =
            useCaseFormula(termLabelState, services, ruleApp,
                inst, useGoal, guardJb, guardFalseTerm);
    ...
    public ImmutableList<Goal> apply(Goal goal, Services services, final RuleApp ruleApp)
        ...
        // \replacewith (==> inv );
        prepareInvInitiallyValidBranch(termLabelState, services, ruleApp, inst,
            invTerm, reachableState, initGoal);
