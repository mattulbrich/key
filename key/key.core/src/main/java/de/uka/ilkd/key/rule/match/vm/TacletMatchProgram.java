...
public class TacletMatchProgram {
     ...
     * provided via match conditions.
     * The returned conditions are either {@code null} if no match is possible or
     * {@link MatchConditions} which extends the given conditions
     * by additional constraints (e.g., instantiations of schemavariables) such that they describe
     * the found match
     *
