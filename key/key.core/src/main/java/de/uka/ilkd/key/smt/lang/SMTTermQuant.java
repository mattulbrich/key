...
public class SMTTermQuant extends SMTTerm {
    ...
    public SMTTermQuant(Quant quant, List<SMTTermVariable> bindVars, SMTTerm sub,
            List<List<SMTTerm>> pats) {
        this.quant = quant;
    ...
    public SMTTerm instantiate(SMTTermVariable a, SMTTerm b) {
        ...
        if (newVars.size() < bindVars.size())
             ...
             * 3. Instantiation of quantified variables should can destroy the well-sortedness of
             * patterns term.
             * Because of 1-3 and for simplicity, we just drop the entry pattern its the quantifier
             * is instantiated.
             **/
