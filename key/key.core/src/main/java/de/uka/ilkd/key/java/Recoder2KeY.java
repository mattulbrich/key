...
public class Recoder2KeY implements JavaReader {
    ...
    public Recoder2KeY(Services services, KeYCrossReferenceServiceConfiguration servConf,
            ...
            NamespaceSet nss, TypeConverter tc) {
    ...
    List<recoder.java.CompilationUnit> recoderCompilationUnits(String[] cUnitStrings) {
        ...
        try {
            ...
            LOGGER.debug(
                "recoder2key: IO Error when reading" + "compilation unit " + cUnitStrings[current],
                ioe);
            ...
            if (sr != null) {
                try {
                    ...
                    reportError("IOError reading java program " +
                        cUnitStrings[current] + ". May be file not found or missing permissions.",
                        e);
                }
            }
        }
    ...
    private List<recoder.java.CompilationUnit> parseLibs(FileRepo fileRepo)
        ...
        recoder.java.CompilationUnit rcu = pf.parseCompilationUnit(
            new StringReader("public class " +
                JavaInfo.DEFAULT_EXECUTION_CONTEXT_CLASS + " { public static void "
        ...
        while (tw.next()) {
            ...
            if (pe instanceof MethodDeclaration) {
                ...
                if (!allowed && methDecl.getBody() != null) {
                    LOGGER.warn(
                        "Method body (" + methDecl.getName() + ") should not be allowed: "
                            + rcu.getDataLocation(),
    ...
    protected recoder.java.declaration.MethodDeclaration embedBlock(
        ...
        recoder.java.declaration.MethodDeclaration mdecl =
            new recoder.java.declaration.MethodDeclaration(
                null, null, new ImplicitIdentifier(
    ...
    private recoder.java.declaration.ClassDeclaration interactClassDecl() {
        recoder.java.declaration.ClassDeclaration classContext =
            new recoder.java.declaration.ClassDeclaration(
                null, new ImplicitIdentifier("<virtual_class_for_parsing" + interactCounter + ">"),
                null, null, null);
        interactCounter++;
        classContext.setProgramModelInfo(servConf.getCrossReferenceSourceInfo());
        return classContext;
