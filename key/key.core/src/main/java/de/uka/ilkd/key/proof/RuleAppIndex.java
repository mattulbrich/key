...
public final class RuleAppIndex {
    ...
    public ImmutableList<TacletApp> getTacletAppAt(TacletFilter filter,
        ...
        if (!autoMode) {
            result = result.prepend(interactiveTacletAppIndex.getTacletAppAt(pos,
                filter,
                services));
        }
        result = result.prepend(automatedTacletAppIndex.getTacletAppAt(pos,
            filter,
            services));
        return result;
    }
    ...
    public ImmutableList<TacletApp> getTacletAppAtAndBelow(TacletFilter filter,
        ...
        ImmutableList<TacletApp> result = ImmutableSLList.<TacletApp>nil();
        if (!autoMode) {
            result = result.prepend(interactiveTacletAppIndex.getTacletAppAtAndBelow(pos,
                filter,
                services));
        }
        result = result.prepend(automatedTacletAppIndex.getTacletAppAtAndBelow(pos,
            filter,
            services));
        return result;
    }
    ...
    public ImmutableList<NoPosTacletApp> getNoFindTaclet(TacletFilter filter,
        ...
        result = result.prepend(automatedTacletAppIndex.getNoFindTaclet(filter,
            services));
        return result;
    }
    ...
    public ImmutableList<NoPosTacletApp> getRewriteTaclet(TacletFilter filter,
        ...
        ImmutableList<NoPosTacletApp> result = ImmutableSLList.<NoPosTacletApp>nil();
        if (!autoMode) {
            result = result.prepend(interactiveTacletAppIndex.getRewriteTaclet(pos,
                filter,
                services));
        }
