 ...
 *
 * Unlike the other settings, these settings do not have a fixed set of keys but
 * are driven by arbitrary keys.
 *
 * Hence, all that this class here does, is to essentially delegate methods to
