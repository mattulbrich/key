 ...
 * <p>
 * It will be display within the settings tree by {@link #getDescription()}.
 * Tree children are determined by {@link #getChildren()}. The most important functions are:
...
public interface SettingsProvider {
     ...
     * The children are displayed as children within the {@link javax.swing.JTree}.
     *
     ...
     * <p>
     * Implement this function for search support. The settings dialog ask every provider
     * if a user given search request is "handled" by a settings provider.
     *
