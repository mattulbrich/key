...
public final class ObjectUtil {
     ...
     * @throws NoSuchFieldException Occurred Exception.
     */
    public static Field findField(Class<?> classInstance, String fieldName)
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T invoke(Object obj, Method method, Object... parameters)
     ...
     * @throws NoSuchMethodException Occurred Exception
     */
    public static Method findMethod(Class<?> classInstance, String methodName,
            @SuppressWarnings("rawtypes") Class... parameterClasses) throws NoSuchMethodException {
        if (classInstance != null) {
            try {
