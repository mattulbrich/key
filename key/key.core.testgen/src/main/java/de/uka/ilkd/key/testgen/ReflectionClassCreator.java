...
public class ReflectionClassCreator {
    ...
    private StringBuilder classDecl(boolean staticClass) {
        ...
        r.append(NEW_LINE);
        r.append("// This file was generated by KeY Version " + KeYConstants.VERSION
            + " (www.key-project.org)." + NEW_LINE + NEW_LINE +
    ...
    private StringBuilder ghostMapDecls(boolean ghostMapActive) {
        ...
        r.append("  public static java.util.HashMap<Integer,Object> ghostModelFields;" + NEW_LINE
            + NEW_LINE);

        r.append("  public static int getHash(Class<?> c, Object obj, String attr){" + NEW_LINE);
        r.append(
            "    return c.hashCode() * (obj!=null?obj.hashCode():1) * attr.hashCode();" + NEW_LINE);
     ...
     * This method is also used in Assignment.toString(boolean rfl) to generate the correct method
     * names.
     */
    ...
    private StringBuilder declareGetter(final String sort, final String def,
            final boolean prim) {
        final StringBuilder r = new StringBuilder();
        final String cmd = "      " + (prim
