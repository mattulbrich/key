 ...
 * {@code Customer} instances to something. Each customer has a unique ID and
 ...
 * for the original {@code Customer} instance. The {@link Map} can not separate between original and
 * clone.
