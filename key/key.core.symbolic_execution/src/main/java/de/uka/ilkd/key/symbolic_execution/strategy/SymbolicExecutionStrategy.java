    ...
    public static class Factory implements StrategyFactory {
        ...
        public StrategySettingsDefinition getSettingsDefinition() {
            ...
            OneOfStrategyPropertyDefinition methodTreatment =
                new OneOfStrategyPropertyDefinition(StrategyProperties.METHOD_OPTIONS_KEY,
                    "Method Treatment",
            ...
            OneOfStrategyPropertyDefinition loopTreatment =
                new OneOfStrategyPropertyDefinition(StrategyProperties.LOOP_OPTIONS_KEY,
                    "Loop Treatment",
            ...
            OneOfStrategyPropertyDefinition blockTreatment =
                new OneOfStrategyPropertyDefinition(StrategyProperties.BLOCK_OPTIONS_KEY,
                    "Block Treatment",
            ...
            OneOfStrategyPropertyDefinition aliasChecks = new OneOfStrategyPropertyDefinition(
                StrategyProperties.SYMBOLIC_EXECUTION_ALIAS_CHECK_OPTIONS_KEY,
                "Alias Checks",
                new StrategyPropertyValueDefinition(
